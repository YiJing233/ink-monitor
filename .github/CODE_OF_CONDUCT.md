...
repository, issue tracker, discussions, and any other channel the project
uses — and also applies when an individual is officially representing the
community in public spaces. Examples include using an official project
...
[insert email / contact form]. All complaints will be reviewed and
