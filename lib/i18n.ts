...
const en: Dict = {
  ...
  // Admin — Generic per-widget config editor (QR-backed, schema-driven)
  'admin.editConfig.h': 'Widget config',
  'admin.editConfig.editorH': 'Widget config — edit',
  'admin.editConfig.notFound': 'Widget <code>{id}</code> not found, or it doesn\'t belong to the current account.',
  'admin.editConfig.backToCanvas': '← Back to Canvas',
  'admin.editConfig.body': 'This is what you see after scanning the QR on the e-ink display. Edit the fields below to update what the widget renders.',
  'admin.editConfig.noSchema': 'Widget <code>{manifest}</code> does not declare an editable config schema.',
  'admin.editConfig.noSchemaHint': 'Add a <code>config_schema</code> to the manifest to enable the QR editor.',
  'admin.editConfig.field.widgetId': 'Widget id',
  'admin.editConfig.field.manifest': 'Manifest',
  'admin.editConfig.counter.chars': '{count} / {max} chars',
  'admin.editConfig.counter.lines': '{count} / {max} lines · ≤ {len} chars per line',
  'admin.editConfig.err.tooLong': 'too long (max {len} chars)',
  'admin.editConfig.err.tooManyLines': 'too many lines (max {max})',
  'admin.editConfig.err.lineTooLong': ' · a line exceeds {len} chars',
  'admin.editConfig.err.min': 'below minimum {min}',
  'admin.editConfig.err.max': 'above maximum {max}',
  'admin.editConfig.bool.on': 'On',
  'admin.editConfig.bool.off': 'Off',
  'admin.editConfig.saving': 'Saving…',
  'admin.editConfig.save': 'Save',
  'admin.editConfig.status.saved': 'Saved',
  'admin.editConfig.status.saveFailed': 'Save failed: {message}',
  ...
  'admin.diag.h': 'Diagnostics',
  'admin.diag.body': 'Owner-only view of the widget platform. Surfaces the validation status, last-resolve timing and error for every widget instance, plus the dashboard/device placement map. Data is sourced from <code>/api/diagnostics/widgets</code>.',
  'admin.diag.refresh': 'Refresh',
  'admin.diag.refreshing': 'Refreshing…',
  'admin.diag.loadFailed': 'Failed to load diagnostics: {message}',
  'admin.diag.section.health': 'Platform health',
  'admin.diag.health.db': 'Database',
  'admin.diag.health.albumStore': 'Album store',
  'admin.diag.health.uploads': 'Uploads enabled',
  'admin.diag.health.uploadMax': 'Upload size cap',
  'admin.diag.health.ssrf': 'SSRF guard',
  'admin.diag.health.node': 'Node version',
  'admin.diag.health.uptime': 'Uptime',
  'admin.diag.health.yes': 'yes',
  'admin.diag.health.no': 'no',
  'admin.diag.section.widgets': 'Installed widgets ({count})',
  'admin.diag.widget.col.name': 'Name',
  'admin.diag.widget.col.version': 'Version',
  'admin.diag.widget.col.validate': 'Validate',
  'admin.diag.widget.col.lastResolveMs': 'Last resolve',
  'admin.diag.widget.col.lastError': 'Last error',
  'admin.diag.widget.col.lastResolvedAt': 'Last resolved',
  'admin.diag.widget.col.actions': 'Actions',
  'admin.diag.widget.action.viewOnCanvas': 'View on canvas',
  'admin.diag.widget.noVersion': '—',
  'admin.diag.widget.noResolve': 'never',
  'admin.diag.section.dashboards': 'Dashboards ({count})',
  'admin.diag.dashboard.col.id': 'ID',
  'admin.diag.dashboard.col.name': 'Name',
  'admin.diag.dashboard.col.widgetCount': 'Widgets',
  'admin.diag.dashboard.col.devices': 'Devices',
  'admin.diag.dashboard.noDevices': 'none',
  'admin.diag.summary': '{total} widgets · {ok} OK · {failing} failing',
  'admin.diag.summary.empty': 'No widgets installed yet.',
  'admin.diag.empty': 'Nothing here yet — install a widget from <a href="/admin/market">Market</a> or save a manifest from <a href="/admin/canvas">Canvas</a>.',
};
...
const zh: Dict = {
  ...
  'admin.editConfig.h': 'Widget config',
  'admin.editConfig.editorH': 'Widget config — 编辑',
  'admin.editConfig.notFound': '找不到 widget <code>{id}</code>，或它不属于当前账号。',
  'admin.editConfig.backToCanvas': '← 返回 Canvas',
  'admin.editConfig.body': '在水墨屏上扫码后看到的就是这里。编辑下方字段即可更新组件的渲染内容。',
  'admin.editConfig.noSchema': 'Widget <code>{manifest}</code> 没有声明可编辑的 config schema。',
  'admin.editConfig.noSchemaHint': '在 manifest 中加入 <code>config_schema</code> 即可启用扫码编辑器。',
  'admin.editConfig.field.widgetId': 'Widget id',
  'admin.editConfig.field.manifest': 'Manifest',
  'admin.editConfig.counter.chars': '{count} / {max} 字符',
  'admin.editConfig.counter.lines': '{count} / {max} 行 · 每行 ≤ {len} 字符',
  'admin.editConfig.err.tooLong': '太长（最多 {len} 字符）',
  'admin.editConfig.err.tooManyLines': '行数过多（最多 {max}）',
  'admin.editConfig.err.lineTooLong': ' · 有行超过 {len} 字符',
  'admin.editConfig.err.min': '低于最小值 {min}',
  'admin.editConfig.err.max': '高于最大值 {max}',
  'admin.editConfig.bool.on': '开',
  'admin.editConfig.bool.off': '关',
  'admin.editConfig.saving': '保存中…',
  'admin.editConfig.save': '保存',
  'admin.editConfig.status.saved': '已保存',
  'admin.editConfig.status.saveFailed': '保存失败: {message}',
  ...
  'admin.diag.h': '诊断',
  'admin.diag.body': '仅本人可见的 Widget 平台视图。展示每个 widget 实例的校验状态、最近一次 source 解析耗时与错误，以及 dashboard / 设备的摆放关系。数据来自 <code>/api/diagnostics/widgets</code>。',
  'admin.diag.refresh': '刷新',
  'admin.diag.refreshing': '刷新中…',
  'admin.diag.loadFailed': '加载诊断失败: {message}',
  'admin.diag.section.health': '平台健康度',
  'admin.diag.health.db': '数据库',
  'admin.diag.health.albumStore': '相册存储',
  'admin.diag.health.uploads': '启用上传',
  'admin.diag.health.uploadMax': '上传大小上限',
  'admin.diag.health.ssrf': 'SSRF 防护',
  'admin.diag.health.node': 'Node 版本',
  'admin.diag.health.uptime': '运行时间',
  'admin.diag.health.yes': '是',
  'admin.diag.health.no': '否',
  'admin.diag.section.widgets': '已安装 widget ({count})',
  'admin.diag.widget.col.name': '名称',
  'admin.diag.widget.col.version': '版本',
  'admin.diag.widget.col.validate': '校验',
  'admin.diag.widget.col.lastResolveMs': '最近解析',
  'admin.diag.widget.col.lastError': '最近错误',
  'admin.diag.widget.col.lastResolvedAt': '解析时间',
  'admin.diag.widget.col.actions': '操作',
  'admin.diag.widget.action.viewOnCanvas': '在 Canvas 中查看',
  'admin.diag.widget.noVersion': '—',
  'admin.diag.widget.noResolve': '从未',
  'admin.diag.section.dashboards': 'Dashboard ({count})',
  'admin.diag.dashboard.col.id': 'ID',
  'admin.diag.dashboard.col.name': '名称',
  'admin.diag.dashboard.col.widgetCount': 'widget 数',
  'admin.diag.dashboard.col.devices': '设备',
  'admin.diag.dashboard.noDevices': '无',
  'admin.diag.summary': '共 {total} 个 widget · {ok} 个正常 · {failing} 个失败',
  'admin.diag.summary.empty': '尚未安装任何 widget。',
  'admin.diag.empty': '这里还没有内容 — 去 <a href="/admin/market">Market</a> 安装一个 widget，或在 <a href="/admin/canvas">Canvas</a> 里保存一个 manifest。',
};
...
const ja: Dict = {
  ...
  'admin.editConfig.h': 'Widget config',
  'admin.editConfig.editorH': 'Widget config — 編集',
  'admin.editConfig.notFound': 'ウィジェット <code>{id}</code> が見つからないか、現在のアカウントに属していません。',
  'admin.editConfig.backToCanvas': '← Canvas に戻る',
  'admin.editConfig.body': '電子ペーパーで QR をスキャンした後に表示されるのはここです。下のフィールドを編集すると、ウィジェットの表示内容が更新されます。',
  'admin.editConfig.noSchema': 'ウィジェット <code>{manifest}</code> は編集可能な config schema を宣言していません。',
  'admin.editConfig.noSchemaHint': 'QR エディタを有効にするには manifest に <code>config_schema</code> を追加してください。',
  'admin.editConfig.field.widgetId': 'Widget id',
  'admin.editConfig.field.manifest': 'Manifest',
  'admin.editConfig.counter.chars': '{count} / {max} 文字',
  'admin.editConfig.counter.lines': '{count} / {max} 行 · 1 行 ≤ {len} 文字',
  'admin.editConfig.err.tooLong': '長すぎます（最大 {len} 文字）',
  'admin.editConfig.err.tooManyLines': '行数が多すぎます（最大 {max}）',
  'admin.editConfig.err.lineTooLong': ' · {len} 文字を超える行があります',
  'admin.editConfig.err.min': '最小値 {min} を下回っています',
  'admin.editConfig.err.max': '最大値 {max} を超えています',
  'admin.editConfig.bool.on': 'オン',
  'admin.editConfig.bool.off': 'オフ',
  'admin.editConfig.saving': '保存中…',
  'admin.editConfig.save': '保存',
  'admin.editConfig.status.saved': '保存しました',
  'admin.editConfig.status.saveFailed': '保存失敗: {message}',
  ...
  'admin.diag.h': '診断',
  'admin.diag.body': 'オーナー専用のウィジェットプラットフォームビュー。各ウィジェットインスタンスの検証状態、直近のソース解決時間とエラー、ダッシュボード/デバイス配置マップを表示します。データは <code>/api/diagnostics/widgets</code> から取得します。',
  'admin.diag.refresh': '更新',
  'admin.diag.refreshing': '更新中…',
  'admin.diag.loadFailed': '診断の読み込みに失敗しました: {message}',
  'admin.diag.section.health': 'プラットフォーム健全性',
  'admin.diag.health.db': 'データベース',
  'admin.diag.health.albumStore': 'アルバムストア',
  'admin.diag.health.uploads': 'アップロード有効',
  'admin.diag.health.uploadMax': 'アップロードサイズ上限',
  'admin.diag.health.ssrf': 'SSRF 防御',
  'admin.diag.health.node': 'Node バージョン',
  'admin.diag.health.uptime': '稼働時間',
  'admin.diag.health.yes': 'はい',
  'admin.diag.health.no': 'いいえ',
  'admin.diag.section.widgets': 'インストール済みウィジェット ({count})',
  'admin.diag.widget.col.name': '名前',
  'admin.diag.widget.col.version': 'バージョン',
  'admin.diag.widget.col.validate': '検証',
  'admin.diag.widget.col.lastResolveMs': '直近の解決',
  'admin.diag.widget.col.lastError': '直近のエラー',
  'admin.diag.widget.col.lastResolvedAt': '解決時刻',
  'admin.diag.widget.col.actions': '操作',
  'admin.diag.widget.action.viewOnCanvas': 'Canvas で表示',
  'admin.diag.widget.noVersion': '—',
  'admin.diag.widget.noResolve': 'なし',
  'admin.diag.section.dashboards': 'ダッシュボード ({count})',
  'admin.diag.dashboard.col.id': 'ID',
  'admin.diag.dashboard.col.name': '名前',
  'admin.diag.dashboard.col.widgetCount': 'ウィジェット数',
  'admin.diag.dashboard.col.devices': 'デバイス',
  'admin.diag.dashboard.noDevices': 'なし',
  'admin.diag.summary': 'ウィジェット {total} · 正常 {ok} · 失敗 {failing}',
  'admin.diag.summary.empty': 'まだウィジェットはインストールされていません。',
  'admin.diag.empty': 'まだ何もありません — <a href="/admin/market">Market</a> からウィジェットをインストールするか、<a href="/admin/canvas">Canvas</a> で manifest を保存してください。',
};
